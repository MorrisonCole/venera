...
import static com.heisentest.venera.utility.DalvikOpcodes.isAbstract;
import static com.heisentest.venera.utility.DalvikOpcodes.isStatic;

public class VeneraLoggingClassVisitor extends ClassVisitor {

    private final Logger logger = Logger.getLogger(VeneraLoggingClassVisitor.class);
    ...
    public VeneraLoggingClassVisitor(int asmApiLevel, ClassVisitor classVisitor, String className, InstrumentationSpy instrumentationSpy) {
