...
import com.heisentest.venera.Descriptors;
import org.apache.log4j.Logger;
import org.ow2.asmdex.MethodVisitor;

import static org.ow2.asmdex.Opcodes.*;

public abstract class VeneraRegisterAllocatingMethodVisitor extends MethodVisitor {

    private final Logger logger = Logger.getLogger(VeneraRegisterAllocatingMethodVisitor.class);
    ...
    public VeneraRegisterAllocatingMethodVisitor(int api, MethodVisitor methodVisitor, String desc, boolean isStatic) {
