...
import com.heisentest.venera.utility.DalvikTypeDescriptor;
...
public class Main {
    ...
    public static void main(String arguments[]) {
        ...
        logger.debug("Starting up Venera!");
        ...
        final VeneraApkInstrumenter veneraApkInstrumenter = new VeneraApkInstrumenter(applicationApkPath,
        ...
        try {
            veneraApkInstrumenter.instrumentApks();
    ...
    private static void printUsage() {
        ...
        helpFormatter.printHelp("Venera", options, PRINT_AUTO_USAGE);
    }
}
