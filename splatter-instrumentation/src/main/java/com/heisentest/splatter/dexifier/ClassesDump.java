...
public static void dumpHeisentestJsonLogger(ApplicationWriter aw) {
	...
	cv = aw.visitClass(ACC_PUBLIC + ACC_FINAL, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", null, "Ljava/lang/Object;", null);
	cv.visit(0, ACC_PUBLIC + ACC_FINAL, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", null, "Ljava/lang/Object;", null);
	...
	{
		fv = cv.visitField(ACC_PRIVATE + ACC_STATIC, "currentlyLogging", "Z", null, null);
		fv.visitEnd();
	}
	{
	...
	{
		fv = cv.visitField(ACC_PRIVATE + ACC_STATIC, "jsonWriter", "Landroid/util/JsonWriter;", null, null);
		fv.visitEnd();
	}
	{
	...
	}
	{
		...
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 1, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "beginArray", "Landroid/util/JsonWriter;", new int[] { 1 });
	...
	}
	{
		...
		mv.visitVarInsn(INSN_CONST_4, 3, 0);
		mv.visitFieldInsn(INSN_SPUT_BOOLEAN, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "currentlyLogging", "Z", 3, 0);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 3, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "endArray", "Landroid/util/JsonWriter;", new int[] { 3 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 3, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "close", "V", new int[] { 3 });
		...
		mv.visitStringInsn(INSN_CONST_STRING, 3, "HeisentestLogger");
		mv.visitMethodInsn(INSN_INVOKE_STATIC, "Landroid/util/Log;", "i", "ILjava/lang/String;Ljava/lang/String;", new int[] { 3, 2 });
		mv.visitLabel(l1);
	...
	}
	{
		...
		mv.visitFieldInsn(INSN_SPUT_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "outputFile", "Ljava/io/File;", 2, 0);
		mv.visitTypeInsn(INSN_NEW_INSTANCE, 2, 0, 0, "Ljava/io/FileWriter;");
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "outputFile", "Ljava/io/File;", 3, 0);
		mv.visitVarInsn(INSN_CONST_4, 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_DIRECT, "Ljava/io/FileWriter;", "<init>", "VLjava/io/File;Z", new int[] { 2, 3, 4 });
		mv.visitFieldInsn(INSN_SPUT_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "fileWriter", "Ljava/io/FileWriter;", 2, 0);
		...
		mv.visitFieldInsn(INSN_SPUT_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "stringWriter", "Ljava/io/StringWriter;", 2, 0);
		mv.visitTypeInsn(INSN_NEW_INSTANCE, 2, 0, 0, "Landroid/util/JsonWriter;");
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "stringWriter", "Ljava/io/StringWriter;", 3, 0);
		mv.visitMethodInsn(INSN_INVOKE_DIRECT, "Landroid/util/JsonWriter;", "<init>", "VLjava/io/Writer;", new int[] { 2, 3 });
		mv.visitFieldInsn(INSN_SPUT_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 2, 0);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 2, 0);
		mv.visitStringInsn(INSN_CONST_STRING, 3, "  ");
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "setIndent", "VLjava/lang/String;", new int[] { 2, 3 });
		mv.visitLabel(l1);
		mv.visitInsn(INSN_RETURN_VOID);
		mv.visitLabel(l2);
		mv.visitIntInsn(INSN_MOVE_EXCEPTION, 0);
	...
	}
	{
		...
		mv.visitCode();
		mv.visitMaxs(9, 0);
		mv.visitFieldInsn(INSN_SGET_BOOLEAN, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "currentlyLogging", "Z", 4, 0);
		Label l0 = new Label();
		...
		Label l2 = new Label();
		Label l3 = new Label();
		mv.visitTryCatchBlock(l0, l2, l3, "Ljava/io/IOException;");
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "beginObject", "Landroid/util/JsonWriter;", new int[] { 4 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitStringInsn(INSN_CONST_STRING, 5, "class");
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "name", "Landroid/util/JsonWriter;Ljava/lang/String;", new int[] { 4, 5 });
		mv.visitIntInsn(INSN_MOVE_RESULT_OBJECT, 4);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "value", "Landroid/util/JsonWriter;Ljava/lang/String;", new int[] { 4, 6 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitStringInsn(INSN_CONST_STRING, 5, "method");
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "name", "Landroid/util/JsonWriter;Ljava/lang/String;", new int[] { 4, 5 });
		mv.visitIntInsn(INSN_MOVE_RESULT_OBJECT, 4);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "value", "Landroid/util/JsonWriter;Ljava/lang/String;", new int[] { 4, 7 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitStringInsn(INSN_CONST_STRING, 5, "parameters");
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "name", "Landroid/util/JsonWriter;Ljava/lang/String;", new int[] { 4, 5 });
		mv.visitArrayLengthInsn(4, 8);
		Label l4 = new Label();
		mv.visitJumpInsn(INSN_IF_LEZ, l4, 4, 0);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "beginArray", "Landroid/util/JsonWriter;", new int[] { 4 });
		...
		mv.visitLabel(l5);
		Label l6 = new Label();
		mv.visitJumpInsn(INSN_IF_GE, l6, 1, 2);
		...
		mv.visitIntInsn(INSN_MOVE_RESULT_OBJECT, 5);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "value", "Landroid/util/JsonWriter;Ljava/lang/String;", new int[] { 4, 5 });
		Label l8 = new Label();
		mv.visitLabel(l8);
		...
		mv.visitLabel(l7);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "nullValue", "Landroid/util/JsonWriter;", new int[] { 4 });
		...
		mv.visitLabel(l6);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "endArray", "Landroid/util/JsonWriter;", new int[] { 4 });
		Label l9 = new Label();
		mv.visitLabel(l9);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "endObject", "Landroid/util/JsonWriter;", new int[] { 4 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "jsonWriter", "Landroid/util/JsonWriter;", 4, 0);
		mv.visitMethodInsn(INSN_INVOKE_VIRTUAL, "Landroid/util/JsonWriter;", "flush", "V", new int[] { 4 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "fileWriter", "Ljava/io/FileWriter;", 4, 0);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestJsonLogger;", "stringWriter", "Ljava/io/StringWriter;", 5, 0);
