...
public static void dumpHeisentestXmlLogger(ApplicationWriter aw) {
	...
	{
		fv = cv.visitField(ACC_PRIVATE + ACC_STATIC, "file", "Ljava/io/File;", null, null);
		fv.visitEnd();
	}
	{
	...
	}
	{
		...
		mv.visitMethodInsn(INSN_INVOKE_STATIC, "Landroid/util/Log;", "d", "ILjava/lang/String;Ljava/lang/String;", new int[] { 4, 5 });
		mv.visitStringInsn(INSN_CONST_STRING, 4, "HeisentestLogger");
		mv.visitStringInsn(INSN_CONST_STRING, 5, "Setting output file (at '%s') readable...");
		mv.visitVarInsn(INSN_CONST_4, 6, 1);
		mv.visitTypeInsn(INSN_NEW_ARRAY, 6, 0, 6, "[Ljava/lang/Object;");
		mv.visitVarInsn(INSN_CONST_4, 7, 0);
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestXmlLogger;", "file", "Ljava/io/File;", 8, 0);
		...
		mv.visitIntInsn(INSN_MOVE_RESULT_OBJECT, 5);
		mv.visitMethodInsn(INSN_INVOKE_STATIC, "Landroid/util/Log;", "d", "ILjava/lang/String;Ljava/lang/String;", new int[] { 4, 5 });
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestXmlLogger;", "file", "Ljava/io/File;", 4, 0);
		mv.visitVarInsn(INSN_CONST_4, 5, 1);
		...
		mv.visitStringInsn(INSN_CONST_STRING, 4, "HeisentestLogger");
		mv.visitStringInsn(INSN_CONST_STRING, 5, "Failed to make output file readable!");
		mv.visitMethodInsn(INSN_INVOKE_STATIC, "Landroid/util/Log;", "e", "ILjava/lang/String;Ljava/lang/String;", new int[] { 4, 5 });
		mv.visitLabel(l3);
		mv.visitStringInsn(INSN_CONST_STRING, 4, "HeisentestLogger");
		mv.visitStringInsn(INSN_CONST_STRING, 5, "Successfully made output file readable. Printing final output:");
		mv.visitMethodInsn(INSN_INVOKE_STATIC, "Landroid/util/Log;", "d", "ILjava/lang/String;Ljava/lang/String;", new int[] { 4, 5 });
		...
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestXmlLogger;", "file", "Ljava/io/File;", 5, 0);
	...
	}
	{
		...
		mv.visitMethodInsn(INSN_INVOKE_DIRECT, "Ljava/io/File;", "<init>", "VLjava/lang/String;", new int[] { 2, 1 });
		mv.visitFieldInsn(INSN_SPUT_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestXmlLogger;", "file", "Ljava/io/File;", 2, 0);
		mv.visitTypeInsn(INSN_NEW_INSTANCE, 2, 0, 0, "Ljava/io/FileWriter;");
		mv.visitFieldInsn(INSN_SGET_OBJECT, "Lcom/heisentest/skeletonandroidapp/HeisentestXmlLogger;", "file", "Ljava/io/File;", 3, 0);
